    ...
    <div class="max-w-xl mx-auto">
      <div class="flex items-center gap-4 mb-6">
        <button
          ...
          @click="router.push('/shipper/schedules')"
        >
          ← スケジュール検索へ
        </button>
      ...
      >
        ...
        <p class="font-mono text-lg font-bold text-gray-700 mb-1">
          {{ trackingNumber }}
        </p>
        <p class="text-xs text-gray-400 mb-4">
          荷物置き場にQRコードが見えるよう置いてください
        </p>
        ...
        <div class="flex gap-3 justify-center">
          ...
          <button
            ...
            @click="router.push('/shipper/bookings')"
          >
            予約一覧へ
          </button>
        </div>
      ...
      >
        <div
          v-if="scheduleId"
          class="bg-gray-50 rounded px-3 py-2 mb-6 text-xs text-gray-500"
        >
        ...
        >
          ...
          <button
            type="submit"
            :disabled="loading || form.weightKg > 10 || form.sizeCm > 140"
